...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: '🎵', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🎥', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '📺', fromMe: true, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '❓', fromMe: true, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🔎', fromMe: true, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🎼', fromMe: true, desc: Slang.LY_DESC }, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🎵', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🎥', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '📺', fromMe: false, desc: Lang.YT_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '❓', fromMe: false, desc: Lang.WIKI_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🔎', fromMe: false, desc: Lang.IMG_DESC}, (async (message, match) => { 
    ...
    Asena.addCommand({pattern: '🎼', fromMe: false, desc: Slang.LY_DESC }, (async (message, match) => {
