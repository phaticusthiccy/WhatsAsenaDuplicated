...
if (CON.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'whois', fromMe: true, desc: Lang.WHO }, async (message, match) => { 
    ...
    Asena.addCommand({ pattern: 'whois', fromMe: false, desc: Lang.WHO }, async (message, match) => { 
