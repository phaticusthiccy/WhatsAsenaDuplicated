...
Asena.addCommand({pattern: 'blurimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Fotoğrafa Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Fotoğraf Arka Planı Blurlanıyor.```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'mp4blur', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Videoya Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Video Arka Planı Blurlanıyor.```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'mp3pitch', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Ses Dosyasına Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Ses’e Pitch Uygulanıyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'mp4edge', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Videoya Dosyasına Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Videoya Edge Uygulanıyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'mp3low', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Ses Dosyasına Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Ses’e Lowpass Uygulanıyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'x2mp3', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Ses Dosyasına Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Ses Hızlandırılıyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'edgeimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Fotoğrafa Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Fotoğrafa Edge Uygulanıyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'enhanceimage', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Fotoğrafa Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Fotoğraf Enhance Ediliyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
...
Asena.addCommand({pattern: 'mp3volume', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false) return await message.sendMessage('*Bir Ses Dosyasına Yanıt Vermelisin!*');
    var downloading = await message.client.sendMessage(message.jid,'```Ses Seviyesi Arttırılıyor..```',MessageType.text);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
            id: message.reply_message.id
