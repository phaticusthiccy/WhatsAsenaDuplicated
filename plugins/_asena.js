...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'aliyefh' ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *InvenTor/WhatsAsena Private* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
    ...
    Asena.addCommand({pattern: 'aliyefh' ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            if (CMD_HELP === '') CMD_HELP += Lang.NOT_FOUND;
            await message.client.sendMessage(
                message.jid,'●▬▬▬ *InvenTor/WhatsAsena Public* ▬▬▬●\n\n' + CMD_HELP, MessageType.text
            );
        }
    }));
}
