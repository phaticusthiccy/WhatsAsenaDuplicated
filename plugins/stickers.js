...
if (Config.WORKTYPE == 'private') {
    Asena.addCommand({pattern: '🐧', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: '🐧', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
